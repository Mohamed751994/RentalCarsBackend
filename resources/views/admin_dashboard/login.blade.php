...
<head>
    ...
    <title>كاركيت لوحة التحكم | تسجيل الدخول</title>
</head>
                ...
                <div class="card shadow rounded-0 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-lg-6 bg-login d-flex align-items-center justify-content-center">
                            <img src="{{asset('admin_dashboard/assets/images/imgIntro.png')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">
                               <div class="text-center">
                                   <img src="{{asset('admin_dashboard/assets/images/logo.png')}}" width="50%" class="login-logo img-fluid" alt="">
                               </div>
                                <h5 class="card-title my-3 text-center">  تسجيل الدخول | لوحة التحكم </h5>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="email" class="form-control radius-30 ps-5" required name="email" value="{{old('email')}}" id="inputEmailAddress" placeholder="ادخل البريد الالكتروني">
                                            </div>
                                        </div>
                                        <div class="col-12">
